...
export function LoginForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login(form); // gọi API login, cookie sẽ được lưu
      // Gọi API lấy user
      const res = await getMe();
      setUser(res.data.user); // lưu user vào Zustand
      ...
      // Nếu dùng axios, lỗi thường là object có response.data.message
        ...
        <div className="grid gap-3">
          <div className="flex items-center">
            ...
            <a
              ...
              onClick={() => toast.info("This feature will be updated soon")}
            >
